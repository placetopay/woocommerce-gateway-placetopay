    ...
    public static function getFields(GatewayMethod $gatewayMethod): array
    {
        $fields = [
            ...
            'payment_button_image' => [
                ...
                'type' => 'text',
                'description' => sprintf(__('It can be a URL, an image name (provide the image to the %s team as svg format for this to work) or a local path (save the image to the wp-content/uploads folder', 'woocommerce-gateway-translations'), $gatewayMethod->getClient()),
                'default' => '',
            ],
            'minimum_amount' => [
                'title' => __('Minimum amount', 'woocommerce-gateway-translations'),
                'type' => 'text',
                'description' => __('Minimum amount to use this payment method', 'woocommerce-gateway-translations'),
                'default' => '',
                'desc_tip' => true,
            ],
            'maximum_amount' => [
                ...
                'type' => 'text',
                'description' => __('Maximum amount to use this payment method', 'woocommerce-gateway-translations'),
                'default' => '',
                'desc_tip' => true,
            ],
            'taxes_others' => [
