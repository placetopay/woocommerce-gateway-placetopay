...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		...
		<tfoot>
            <?php $metaStatus = get_post_meta($order->get_id(), \PlacetoPay\PaymentMethod\GatewayMethod::META_STATUS, true ); ?>
            <?php if ($metaStatus == 'APPROVED_PARTIAL' && $order->get_status() == 'pending') : ?>
                <tr>
                    <th scope="row" colspan="2"><?php _e('Total Paid:', 'woocommerce-gateway-placetopay'); ?></th>
                    <td class="product-total"><?php echo wc_price($order_total - $balance); ?></td>
                </tr>

                <tr>
                    <th scope="row" colspan="2"><?php _e('Balance:', 'woocommerce-gateway-placetopay'); ?></th>
                    <td class="product-total"><?php echo wc_price($balance); ?></td>
                </tr>
                <?php if ( $totals ) : ?>
